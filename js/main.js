...
// Define and add behaviour buttons

// define action buttions
const startButton = document.getElementById('startButton');
const callButton = document.getElementById('callButton');
const hangupButton = document.getElementById('hangupButton');

// diable call and hang up button (initially)
...
function callAction(){
  ...
  // Allows for RTC server configurations
  const servers = null;

  // Create local peer connection and add behavior
  ...
  // Create remote peer connection and add behavior
  remotePeerConnection = new RTCPeerConnection(servers);
  trace('Created remote peer connection object remotePeerConnection');

  remotePeerConnection.addEventListener('icecandidate', handleConnection);
  remotePeerConnection.addEventListener('iceconnectionstatechange', handleConnectionChange);
  remotePeerConnection.addEventListener('addstream', fetchRemoteMediaStream);
...
// Handles Hang up button action: ends up call, closes connection and resets peers
